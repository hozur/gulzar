			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<?php if(get_post_meta($post->ID, "slider_1", $single = true) != ""){ ?>
							<li data-thumb="<?php echo get_post_meta($post->ID, "slider_1", $single = true); ?>">
								<div class="thumb-image"> <img src="<?php echo get_post_meta($post->ID, "slider_1", $single = true); ?> " data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<?php } ?>
							<?php if(get_post_meta($post->ID, "slider_2", $single = true) != ""){ ?>
							<li data-thumb="<?php echo get_post_meta($post->ID, "slider_2", $single = true); ?>">
								 <div class="thumb-image"> <img src="<?php echo get_post_meta($post->ID, "slider_2", $single = true); ?> " data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<?php } ?>
							<?php if(get_post_meta($post->ID, "slider_3", $single = true) != ""){ ?>
							<li data-thumb="<?php echo get_post_meta($post->ID, "slider_3", $single = true); ?>">
							   <div class="thumb-image"> <img src="<?php echo get_post_meta($post->ID, "slider_3", $single = true); ?> " data-imagezoom="true" class="img-responsive"> </div>
							</li> 
							<?php } ?>
						</ul>
					</div>
